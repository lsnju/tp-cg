...
public interface ${tableMo.restMo.apiName} {
    ...
    @GetMapping()
    BaseResp<PageList<${tableMo.restMo.modelName}>> pageQuery(@Valid @ParameterObject ${tableMo.restMo.pageReqName} request);

    @Operation(summary = "新增")
    @PostMapping()
    BaseResp<Long> create(@Valid @RequestBody ${tableMo.restMo.addReqName} request);
